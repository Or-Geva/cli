...
func TestRunPushFatManifestImage(t *testing.T) {
	...
	require.True(t, isDaemonBuilderRunning(builderContainerName), "docker daemon is not responding in remote container")
...
func isDaemonBuilderRunning(containerName string) bool {
